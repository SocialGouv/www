...
export const meta = {
  ...
  hero: {
    background: "/images/startups/enfants-du-spectacle-hero.png",
    alt: "Photo by Bruno Abatti",
    title: "Enfants du spectacle",
    tagline: "Simplifier la démarche, Protéger les enfants",
  },
};

<LayoutArticle meta={meta} startup="enfantsduspectacle">
