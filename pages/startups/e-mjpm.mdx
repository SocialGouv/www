...
export const footer = <BlocCards cards={[Cards.wif, Cards.cdtn]} />;

export const meta = {
  title: 'Trouver rapidement le bon professionnel pour les majeurs à protéger',
  hero: {
  ...
  links:[{
    ...
    subTitle: 'https://emjpm.beta.gouv.fr',
    href: 'https://emjpm.beta.gouv.fr',
    description:"Page officielle du produit"
  },{
    title: 'Github frontend',
    subTitle: 'code source',
    href: 'https://github.com/socialgouv/eMJPM-app',
    description: "Le code source de l'application Frontend en ReactJS + Next.js"
  },{
    title: 'Github backend',
    subTitle: 'code source',
    href: 'https://github.com/socialgouv/eMJPM-api',
    description: "Le code source de l'application backend avec du NodeJS et PostgreSQL"
  }]
};
...
e-MJPM est une première réponse pour une meilleure gestion des mesures de protection et a pour objectif de simplifier à terme toutes les démarches des professionnels en charge de la protection juridique des majeurs.
</LayoutArticle>
