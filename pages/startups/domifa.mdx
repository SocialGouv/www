...
- Enregistrement des appels, passages, courriers, colis et avis de passage
- Suivi du courrier reçu et distribué aux domiciliés
- Gestion des domiciliations et des échéances associées
- Module de statistiques permettant la rédaction du rapport annuel d'activité
  
DomiFa permet aussi aux domiciliés de mieux visualiser leurs courriers en attente : 
- Réception de notifications SMS lors de la réception de courrier au sein de la structure
- Accès à un portail usager leur permettant de consulter le nombre de courriers en attente
