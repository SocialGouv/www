...
const Saison2 = () => (
  <Layout>
    ...
    />
      ...
      <p align="center"><h3><a href="http://incubateur-des-ministres-sociaux-saison-2.selecteev.io/apply">Proposez votre idée</a> et devenez entrepreneur(se) d'une Startup d'État !</h3></p><br/>
...
Vous avez jusqu'au <b>vendredi 14 Septembre 2018</b> pour déposer votre idée. Si votre candidature est retenue, vous serez ensuite très vite recontacté(e) pour participer à la journée de sélection du <b>jeudi 11 octobre 2018</b>. 
Vous participerez alors à un bootcamp pendant lequel vous serez coaché(e) pour <span data-tip="Présenter de façon très synthétique">pitcher</span> devant un jury d'experts.
</div>      
      </Section>
