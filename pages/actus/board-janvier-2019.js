  ...
  <Layout>
    ...
    >
      <div className="container">
        ...
        ministères. <br />
        <br />
        Ce 15 janvier, le board de la fabrique numérique des ministères sociaux
        a donné son feu vert à la poursuite des startups incubées. <br />
        <br />
        <center>
          <img
            alt="Panneau pitch"
        ...
        et WorkInFrance de la fabrique numérique. Des résultats concrets pour
        ces deux startups d’Etat dont les plateformes en ligne sont de plus en
        plus utilisées sur le territoire et facilitent le travail de nombreux
        professionnels. <br />
