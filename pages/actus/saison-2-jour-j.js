  ...
  <Layout>
    ...
    >
      <div className="container">
        ...
        <br />
        Les idées présentées furent les suivantes : <br />1- Rendre plus
        performant le processus de domiciliation des personnes sans domicile
        stable <br />2- La création d&apos;un guichet d&apos;inscription aux
        formation qualifiantes du ministère des sports. <br />3- Aider les
        services de l&apos;état à mettre rapidement à l&apos;abris les personnes
        à la rue durant l&apos;hiver. <br />4- Mettre en valeur les territoires
        déficitaires en professionels de santé afin de favoriser leur
        installation <br />5- "Dites le nous une fois" pour les entreprises
        étrangères détachant des salariés en France <br />6- Outiller les
        travailleurs sociaux pour accompagner les exclus numériques <br />7-
        ...
        conseillers Mission Locale. <br />8- Améliorer l’accès à l’offre de soins
        en cas d&apos;urgence.
        <br />
        <br /> La matinée et le début d&apos;après-midi ont été consacrés à un
        coaching des candidats puis à la présentation des pitchs.
        <center>
          <img src="/static/images/pitch.jpg" width="40%" /><br/>
          
        </center>
        <br/> Puis, à 15h,
        les présentations officielles ont commencé devant un jury
        d&apos;experts présidé par la secrétaire générale, Mme Sabine Fourcade accompagnée de Jasmine Meurin, intrapreneur de la saison 1 sur le
        produit e-mjpm, Johnathan Redt-Gensinger , intrapreneur de la saison 1
        sur le produit workInFrance, Basile Michardière (Makesense.org) et Julie
        ...
        pôle modernisation et Hélène Brisset, directrice des systèmes d&apos;information.
        <br /> Les orateurs ont eu beaucoup de talent ! Le choix fut compliqué mais c&apos;est au final les
        ...
        <br />
        <center>
          <img src="/static/images/pitchday-1.jpg" width="70%" /><br/>
