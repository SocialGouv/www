  ...
  <Layout>
    ...
    >
      <div className="container">
        ...
        coeur de Paris. <br />
        <br />Les idées présentées furent les suivantes : <br />- Rendre plus
        ...
        pôle modernisation et Hélène Brisset, notre directrice.<br /> Les
        orateurs ont eu beaucoup de talent ! C'est au final les projets 1, 3 et
        4 qui ont remporté l'adhésion du jury. <br />
        <br />A très bientôt pour avoir des nouvelles de nos nouveaux "intras" !<br />
        <br />
        <br />
        <div style={{ textAlign: "center" }}>
          <img src="/static/images/pitchday 1.jpeg" width="70%" />
        </div>
        <br />
      </div>
    </Section>
